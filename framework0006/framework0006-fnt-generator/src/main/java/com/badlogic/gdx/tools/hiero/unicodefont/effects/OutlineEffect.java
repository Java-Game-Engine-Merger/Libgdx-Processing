...
public class OutlineEffect implements ConfigurableEffect{
  ...
  /**
   * Sets the width of the outline. The glyphs will need padding so the outline doesn't get
   * clipped.
   */
  ...
  /**
   * Sets the stroke to use for the outline. If this is set, the other outline settings are
   * ignored.
   */
  ...
  /**
   * Sets how the corners of the outline are drawn. This is usually only noticeable at large
   * outline widths.
   * 
