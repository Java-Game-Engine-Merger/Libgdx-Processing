...
/**
 * Processes the maps located in gdx-tests-android: "assets/data/maps/tiled-atlas-src" Creates
 * the directory
 * "assets/data/maps/tiled-atlas-processed/deleteMe" which contains processed maps. Run
 * TiledMapPackerTestRender to render the
