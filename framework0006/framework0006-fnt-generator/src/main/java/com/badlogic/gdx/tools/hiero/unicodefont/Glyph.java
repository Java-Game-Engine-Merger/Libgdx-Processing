...
public class Glyph{
  ...
  /**
   * The shape to use to draw this glyph. This is set to null after the glyph is stored in a
   * GlyphPage.
   */
  ...
  /**
   * The distance from drawing y location to top of this glyph, causing the glyph to sit on the
   * baseline.
   */
