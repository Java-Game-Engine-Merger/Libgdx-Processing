...
public class GradientEffect implements ConfigurableEffect{
  ...
  /**
   * Sets the pixel offset to move the gradient up or down. The gradient is normally centered on
   * the glyph.
   */
  ...
  /**
   * Changes the height of the gradient by a percentage. The gradient is normally the height of
   * most glyphs in the font.
   */
