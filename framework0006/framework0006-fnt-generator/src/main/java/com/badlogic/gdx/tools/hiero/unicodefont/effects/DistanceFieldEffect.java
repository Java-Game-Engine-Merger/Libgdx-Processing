...
/**
 * A filter to create a distance field. The resulting font can be rendered with a simple custom
 * shader to draw bitmap fonts that
 * remain crisp even under high magnification.
 * 
 * <p>
 * An example of the use of such a font is included in the libgdx test suite under the name
 * {@code BitmapFontDistanceFieldTest}.
 * 
