...
/**
 * Contains extra information that can only be calculated after a Tiled Map's tile set images
 * are loaded.
 * 
 * @author David Fraska
 */
public class TileSetLayout{
  ...
  /**
   * Constructs a Tile Set layout. The tile set image contained in the baseDir should be the
   * original tile set images before
