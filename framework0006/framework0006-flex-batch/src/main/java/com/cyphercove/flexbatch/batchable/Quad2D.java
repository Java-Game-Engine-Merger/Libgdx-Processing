 ...
 * two-dimensional position and color. It is designed to be drawn in a 2D plane, and is commonly
 * called a sprite.
 * <p>
 * The default origin of a Quad2D is its bottom left corner. Its origin is used for positioning,
 * and as the center of rotation and
 * scaling.
 * <p>
 * It may be subclassed to create a Batchable class that supports zero or multiple textures and
 ...
 * subclass would not be compatible with a FlexBatch that was instantiated for the base Quad2D
 * type.
 * 
 * @author cypherdare
 */
