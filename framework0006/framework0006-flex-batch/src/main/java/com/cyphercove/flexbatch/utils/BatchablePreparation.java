...
public final class BatchablePreparation{
  ...
  /**
   * Generate vertex attributes suitable for multi-texturing and vertex color. 32 bit floats are
   * used for each position
   * component and texture coordinate. The four color components are packed into a single 32 bit
   * float.
   * 
   ...
   * @param textureCoordinates3D Whether the texture coordinate attribute(s) should include a
   *                             third component.
   * @param attributes           The array to add the vertex attributes to. They are added with
   *                             position and color in the first two
  ...
  /**
   * Populates an array of triangle indices for quadrangles made up of two triangles. The indices
   * are ordered such that they
