...
/**
 * A Batchable supporting a single {@link PolygonRegion}, with color, position, scale, and an
 * origin offset.
 *
...
public abstract class Poly<T extends Poly<T>>extends Batchable{
  ...
  /**
   * Sets the center point for transformations (rotation and scale). For {@link Quad2D}, this is
   * relative to the bottom left
   * corner of the texture region. For {@link Quad3D}, this is relative to the center of the
   * texture region and is in the local
   * coordinate system.
   * 
   * @return This object for chaining.
   */
