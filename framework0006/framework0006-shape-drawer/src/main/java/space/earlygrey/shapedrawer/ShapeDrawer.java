...
public class ShapeDrawer extends AbstractShapeDrawer{
  ...
  /**
   * <p>
   * Calls {@link #line(float, float, float, float, float)}()}.
   * </p>
   *
   * @param s         the starting point of the line
   * @param e         the end point of the line
  ...
  /**
   * <p>
   * Calls {@link #line(float, float, float, float, float, boolean)}()} with default line width
   * and {@code snap}.
   * </p>
   *
   * @param s     the starting point of the line
  ...
  /**
   * <p>
   * Calls {@link #line(float, float, float, float, float, boolean, float, float)}()} with default
   * line width and {@code snap}.
   * </p>
   *
   * @param s         the starting point of the line
   * @param e         the end point of the line
  ...
  /**
   * <p>
   * Calls {@link #line(float, float, float, float, Color, float)}()} with {@code snap} set to the
   * default value.
   * </p>
   *
   * @param x1        the x-component of the first point
  ...
  /**
   * <p>
   * Calls {@link #line(float, float, float, float, float, boolean)}()} with {@code snap} set to
   * the default value.
   * </p>
   *
   * @param x1        the x-component of the first point
  ...
  /**
   * <p>
   * Calls {@link #line(float, float, float, float, float, boolean, float, float)}()} with the
   * default colour.
   * </p>
   *
   * @param x1        the x-component of the first point
  ...
  /**
   * <p>
   * Calls {@link #line(float, float, float, float, Color, Color)}()}.
   * </p>
   *
   * @param s      the starting point of the line
   * @param e      the end point of the line
  ...
  /**
   * <p>
   * Calls {@link #line(float, float, float, float, float, boolean, Color, Color)}()} with default
   * line width and {@code snap}.
   * </p>
   *
   * @param x1     the x-component of the first point
  ...
  /**
   * <p>
   * Calls {@link #line(float, float, float, float, float, boolean, float, float)}()}.
   * </p>
   *
   * @param x1        the x-component of the first point
   * @param y1        the y-component of the first point
  ...
  /**
   * <p>
   * Calls {@link #path(Iterable, float)} with {@code lineWidth} set to the current default.
   * </p>
   *
  ...
  /**
   * <p>
   * Calls {@link #path(Iterable, float, boolean)} with open set to true.
   * </p>
   *
   * @param path      an ordered Iterable of Vector2s representing path points
  ...
  /**
   * <p>
   * Calls {@link #path(Iterable, float, boolean)} with {@code lineWidth} set to the default.
   * </p>
   *
   * @param path an ordered Iterable of Vector2s representing path points
  ...
  /**
   * <p>
   * Draws a path by drawing a line between each point and the next. See
   * {@link #path(Iterable, float, JoinType, boolean)} for details.
   * </p>
   *
   ...
   * <p>
   * Draws a path by drawing a line between each point and the next. See
   * {@link #path(float[], int, int, float, JoinType, boolean)} for details.
   * </p>
   *
   * @param path      an {@code float[]} containing the ordered points in the path
   * @param start     the index of {@code path} which represents the first point to draw,
   *                  inclusive
  ...
  /**
   * <p>
   * Calls {@link #circle(float, float, float, float)} with default line width.
   * </p>
   *
  ...
  /**
   * <p>
   * Calls {@link #circle(float, float, float, float, JoinType)} with default line width.
   * </p>
   *
   * @param centreX  the x-coordinate of the centre point
   * @param centreY  the y-coordinate of the centre point
  ...
  /**
   * <p>
   * Calls {@link #ellipse(float, float, float, float, float, float)} with rotation set to 0 and
   * default line width.
   * </p>
   *
   * @param centreX the x-coordinate of the centre point
  ...
  /**
   * <p>
   * Calls {@link #ellipse(float, float, float, float, float, float)} with default line width.
   * </p>
   *
   * @param centreX  the x-coordinate of the centre point
   * @param centreY  the y-coordinate of the centre point
  ...
  /**
   * <p>
   * Draws a filled ellipse by calling {@link #filledEllipse(float, float, float, float, float)}
   * with rotation set to 0.
   * </p>
   *
   * @param centreX the x-coordinate of the centre point
   * @param centreY the y-coordinate of the centre point
  ...
  /**
   * <p>
   * Calls {@link #filledEllipse(float, float, float, float, float, float, float)} with the
   * drawer's current colour.
   * </p>
   *
   * @param centreX  the x-coordinate of the centre point
   * @param centreY  the y-coordinate of the centre point
  ...
  /**
   * <p>
   * Calls {@link #filledEllipse(float, float, float, float, float, float, float)}.
   * </p>
   *
   * @param centreX    the x-coordinate of the centre point
   * @param centreY    the y-coordinate of the centre point
  ...
  /**
   * <p>
   * Calls {@link #arc(float, float, float, float, float, float)} with default line width.
   * </p>
   *
   * @param centreX    the x-coordinate of the centre point
   * @param centreY    the y-coordinate of the centre point
  ...
  /**
   * <p>
   * Calls {@link #arc(float, float, float, float, float, float, boolean)} with useJoin set to
   * true.
   * </p>
   *
   * @param centreX    the x-coordinate of the centre point
  ...
  /**
   * <p>
   * Calls {@link #arc(float, float, float, float, float, float, boolean, int)} with the number of
   * sides estimated by {@link #estimateSidesRequired(float, float)}.
   * </p>
   *
   * @param centreX    the x-coordinate of the centre point
   * @param centreY    the y-coordinate of the centre point
   ...
   * @param radians    the angle in radians subtended by the arc
   * @param lineWidth  the width of the line
   * @param useJoin    whether to use a join type, either {@link JoinType#POINTY} or none. See
  ...
  /**
   * <p>
   * Draws an arc from {@code startAngle} anti-clockwise that subtends the specified angle.
   * </p>
   *
   * @param centreX    the x-coordinate of the centre point
   * @param centreY    the y-coordinate of the centre point
  ...
  /**
   * <p>
   * Draws a sector (pie slice) by calling {@link #sector(float, float, float, float, float, int)}
   * with the number of sides estimated by {@link #estimateSidesRequired(float, float)}.
   * </p>
   *
   * @param centreX    the x-coordinate of the centre point
   * @param centreY    the y-coordinate of the centre point
  ...
  /**
   * <p>
   * Draws a sector (pie slice) by calling
   * {@link #sector(float, float, float, float, float, int, float, float)} with the number of
   * sides estimated by {@link #estimateSidesRequired(float, float)}.
   * </p>
   *
   * @param centreX    the x-coordinate of the centre point
   ...
   * <p>
   * Draws a sector (pie slice) by calling
   * {@link #sector(float, float, float, float, float, int, float, float)}.
   * </p>
   *
   * @param centreX    the x-coordinate of the centre point
   * @param centreY    the y-coordinate of the centre point
  ...
  /**
   * <p>
   * Draws a sector (pie slice) by from {@code startAngle} anti-clockwise that subtends the
   * specified angle.
   * </p>
   *
   * @param centreX    the x-coordinate of the centre point
  ...
  /**
   * <p>
   * Draws the regular polygon specified by drawing lines between the vertices.
   * </p>
   *
   * @param centreX   the x-coordinate of the centre point
   * @param centreY   the y-coordinate of the centre point
  ...
  /**
   * <p>
   * Calls {@link #filledPolygon(float, float, int, float, float)} with scaleX and scaleY set to
   * {@code scale} and the rotation set to 0.
   * </p>
   *
   * @param centreX the x-coordinate of the centre point
   * @param centreY the y-coordinate of the centre point
  ...
  /**
   * <p>
   * Calls {@link #filledPolygon(float, float, int, float, float, float, float, float)} with the
   * drawer's current colour.
   * </p>
   *
   * @param centreX  the x-coordinate of the centre point
  ...
  /**
   * <p>
   * Calls {@link #filledPolygon(float, float, int, float, float, float, float, float)}.
   * </p>
   *
   * @param centreX    the x-coordinate of the centre point
   * @param centreY    the y-coordinate of the centre point
  ...
  /**
   * <p>
   * Calls {@link #polygon(Polygon, float, JoinType)} with default line width and join type set to
  ...
  /**
   * <p>
   * Calls {@link #polygon(Polygon, float, JoinType)} with join type set to
   * {@link JoinType#POINTY}.
   * </p>
   *
   * @param polygon   the polygon
  ...
  /**
   * <p>
   * Calls {@link #polygon(Polygon, float, JoinType)} with default line width.
   * </p>
   *
   * @param polygon  the polygon
   * @param joinType the type of join, see {@link JoinType}
  ...
  /**
   * <p>
   * Draws the boundary of the polygon with the given line width and join type.
   * </p>
   *
   * @param polygon   the polygon
   * @param lineWidth the line width
   ...
   * @param vertices  consecutive ordered pairs of the x-y coordinates of the vertices of the
   *                  polygon
   * @param start     the index of {@code vertices} which represents the first vertex to draw,
   *                  inclusive
   * @param end       the index of {@code vertices} which represents the last vertex to draw,
   *                  exclusive
   * @param lineWidth the line width
   */
   ...
   * </p>
   * <p>
   * This calls {@link PathDrawer#path(float[], int, int, float, JoinType, boolean)} with
   * {@code open} set to false.
   * </p>
   *
   * @param vertices  consecutive ordered pairs of the x-y coordinates of the vertices of the
   *                  polygon
  ...
  /**
   * Calls {@link #triangle(float, float, float, float, float, float, float)} with the current
   * drawer colour.
   *
  ...
  /**
   * Calls {@link #triangle(float, float, float, float, float, float, float, JoinType, float)}
   * with the current drawer colour.
   *
   * @param x1        x coord of first vertex
   * @param y1        y coord of first vertex
   * @param x2        x coord of second vertex
  ...
  /**
   * <p>
   * Calls {@link #filledTriangle(float, float, float, float, float, float)}.
   * </p>
   *
  ...
  /**
   * <p>
   * Calls {@link #filledTriangle(float, float, float, float, float, float, Color)}.
   * </p>
   *
   * @param v1    coordinates of the first vertex
   * @param v2    coordinates of the second vertex
  ...
  /**
   * <p>
   * Calls {@link #filledTriangle(float, float, float, float, float, float, float, float, float)}.
   * </p>
   *
   * @param v1     coordinates of the first vertex
   * @param v2     coordinates of the second vertex
   ...
   * <p>
   * Calls {@link #filledTriangle(float, float, float, float, float, float, float, float, float)}
   * with the drawer's current colour.
   * </p>
   *
  ...
  /**
   * <p>
   * Draws a filled triangle with the specified vertices and colours.
   * </p>
   *
   * @param x1     x coordinate of first vertex
   * @param y1     y coordinate of first vertex
  ...
  /**
   * <p>
   * Calls {@link #rectangle(float, float, float, float, float, float, JoinType)} with rotation
   * set to 0.
   * </p>
   *
   * @param x         the x-coordinate of the bottom left corner of the rectangle
  ...
  /**
   * <p>
   * Calls {@link #filledRectangle(float, float, float, float)}.
   * </p>
   *
   * @param rect a {@link Rectangle} object
   */
  ...
  /**
   * <p>
   * Calls {@link #filledRectangle(float, float, float, float, float)} with rotation set to 0.
   * </p>
   *
   * @param x      the x-coordinate of the bottom left corner of the rectangle
   * @param y      the y-coordinate of the bottom left corner of the rectangle
  ...
  /**
   * <p>
   * Sets this drawer's colour, calls {@link #filledRectangle(float, float, float, float)}, then
   * resets the colour.
   * </p>
   *
   * @param x      the x-coordinate of the bottom left corner of the rectangle
