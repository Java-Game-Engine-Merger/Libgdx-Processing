...
/**
 * Holds a cache of shapes drawn with a {@link ShapeDrawer}, which can be drawn at any time
 * without having to perform the shape calculations again.
 * 
 * @author earlygrey
 */
...
public class Drawing{
  ...
  /**
   * Draw the cached shapes to the screen. Must be used in between {@link Batch#begin()} and
   * {@link Batch#end()}.
   */
