...
/**
 * <p>
 * Managers the vertex data and when it it sent to the batch.
 * </p>
 *
 * @author earlygrey
 */
...
class BatchManager{
  ...
  /**
   * <p>
   * Begin caching draw calls by storing vertex information in a float[] until it all gets set to
   * the
   * Batch with one call to {@link Batch#draw(Texture, float[], int, int)}.
   * </p>
   * 
  ...
  /**
   * <p>
   * Stops caching and calls {@link Batch#draw(Texture, float[], int, int)} if anything is cached.
   * </p>
   */
  void endCaching() {
  ...
  /**
   * <p>
   * Adds the colour and texture coordinates of four vertices to the cache and progresses the
   * index. If drawing is
   * not currently being cached, immediately calls {@link #pushToBatch()}.
   * </p>
   * 
  ...
  /**
   * <p>
   * Adds the colour and texture coordinates of three vertices to the cache and progresses the
   * index. If drawing is
   * not currently being cached, immediately calls {@link #pushToBatch()}.
   * </p>
   * 
  ...
  /**
   * <p>
   * Calls {@link Batch#draw(Texture, float[], int, int)} using the currently cached vertex
   * information.
   * </p>
   */
  void pushToBatch() {
  ...
  protected void x1(float x1) {
    verts[getVerticesArrayIndex()+SpriteBatch.X1]=x1;
  }
  protected void y1(float y1) {
    verts[getVerticesArrayIndex()+SpriteBatch.Y1]=y1;
  }
  protected void x2(float x2) {
    verts[getVerticesArrayIndex()+SpriteBatch.X2]=x2;
  }
  protected void y2(float y2) {
    verts[getVerticesArrayIndex()+SpriteBatch.Y2]=y2;
  }
  protected void x3(float x3) {
    verts[getVerticesArrayIndex()+SpriteBatch.X3]=x3;
  }
  protected void y3(float y3) {
    verts[getVerticesArrayIndex()+SpriteBatch.Y3]=y3;
  }
  protected void x4(float x4) {
    verts[getVerticesArrayIndex()+SpriteBatch.X4]=x4;
  }
  protected void y4(float y4) {
    verts[getVerticesArrayIndex()+SpriteBatch.Y4]=y4;
  }
  protected float x1() {
    return verts[getVerticesArrayIndex()+SpriteBatch.X1];
  }
  protected float y1() {
    return verts[getVerticesArrayIndex()+SpriteBatch.Y1];
  }
  protected float x2() {
    return verts[getVerticesArrayIndex()+SpriteBatch.X2];
  }
  protected float y2() {
    return verts[getVerticesArrayIndex()+SpriteBatch.Y2];
  }
  protected float x3() {
    return verts[getVerticesArrayIndex()+SpriteBatch.X3];
  }
  protected float y3() {
    return verts[getVerticesArrayIndex()+SpriteBatch.Y3];
  }
  protected float x4() {
    return verts[getVerticesArrayIndex()+SpriteBatch.X4];
  }
  protected float y4() {
    return verts[getVerticesArrayIndex()+SpriteBatch.Y4];
  }
  void color1(float c) {
    verts[getVerticesArrayIndex()+SpriteBatch.C1]=c;
  }
  void color2(float c) {
    verts[getVerticesArrayIndex()+SpriteBatch.C2]=c;
  }
  void color3(float c) {
    verts[getVerticesArrayIndex()+SpriteBatch.C3]=c;
  }
  void color4(float c) {
    verts[getVerticesArrayIndex()+SpriteBatch.C4]=c;
  }
}
