...
public class GraphDrawerDrawable extends ShapeDrawerDrawable{
  ...
  /**
   * The Interpolation that describes the graph's formula. See {@link Interpolation} for available
   * defaults or create
   * your own!
   */
  ...
  /**
   * Constructs a GraphDrawerDrawable. The Batch of the provided ShapeDrawer/GraphDrawer must be
   * the same Batch at
   * rendering time.
   *
   * @param graphDrawer
