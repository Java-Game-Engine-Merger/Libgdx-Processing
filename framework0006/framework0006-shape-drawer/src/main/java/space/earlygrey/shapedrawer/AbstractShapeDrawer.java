...
/**
 * <p>
 * Contains the mechanics for using the Batch and settings such as line width and pixel size.
 * </p>
 *
 * @author earlygrey
 */
...
public abstract class AbstractShapeDrawer{
  ...
  /**
   * <p>
   * Creates a new ShapeDrawer with the given batch and region.
   * </p>
   *
  ...
  /**
   * <p>
   * Call this when the batch projection or transformation matrices are changed.
   * Calls {@link #update(boolean)} with {@code updatePixelSize} set to true.
   * </p>
   * <p>
   * NOTE: if you are not using an orthographic projection, you should call
   * {@link #update(boolean)} with {@code updatePixelSize} set to false.
   * </p>
   */
  public void update() {
    update(true);
   ...
   * and only if {@code updatePixelSize} is set to true.
   * </p>
   *
  ...
  /**
   * <p>
   * This uses the current projection and transformation matrices of the Batch to calculate the
   * size of a screen pixel along the x-axis in world units, and calls
   * {@link #setPixelSize(float)} with
   * that value. You should use this if you have changed the batch projection or transformation
   * matrices,
   * or more generally can just call {@link #update()}.
   * </p>
   * <p>
   * NOTE: this only works when the projection is orthographic!
   * </p>
   *
  ...
  /**
   * <p>
   * Makes a guess as to whether joins will be discernible on the screen on based on the thickness
   * of the line.
   * This affects the default behaviour when a {@link JoinType} is unspecified.
   * </p>
   * <p>
   * You can override this if you want to change this behaviour.
   * </p>
   *
  ...
  /**
   * <p>
   * Sets a new {@link SideEstimator} and returns the old {@link SideEstimator}.
   * </p>
   *
   * @param sideEstimator
  ...
  /**
   * <p>
   * This is used internally to make estimates about how things will appear on screen. It affects
   * line endpoint snapping (see
   * {@link ShapeDrawer#line(float, float, float, float, float, boolean)}) and
   * estimating the number of sides required to draw an ellipse
   * (see {@link ShapeDrawer#ellipse(float, float, float, float, float, float)}).
   * </p>
   *
  ...
  /**
   * <p>
   * Sets the default line width used if one is not specified in the method signature.
   * </p>
   *
  ...
  /**
   * @return whether lines are snapped to the centre of pixels if it is not specified in the
   *         method signature
   */
  ...
  /**
   * <p>
   * Sets whether line endpoints are snapped to the centre of pixels if it is not specified in the
   * method signature.
   * </p>
   *
  ...
  /**
   * <p>
   * Sets the TextureRegion used to draw.
   * </p>
   *
  ...
  /**
   * <p>
   * Sets the colour of the ShapeDrawer. This works like {@link Batch#setColor(Color)} though
   * drawing is not affected by
   * the colour of the Batch. Internally only the packed float value is stored, see
  ...
  /**
   * <p>
   * Sets the colour of the ShapeDrawer. This works just like {@link Batch#setColor(Color)} though
   * drawing is not affected by
  ...
  /**
   * <p>
   * Sets the packed colour using {@link Color#toFloatBits(float, float, float, float)}.
   * </p>
   *
   * @param r
   * @param g
