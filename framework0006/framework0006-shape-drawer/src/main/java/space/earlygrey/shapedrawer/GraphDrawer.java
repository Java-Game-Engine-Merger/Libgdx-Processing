...
/**
 * Contains functions for drawing graphs of {@link Interpolation} instances. Use the default
 * interpolations or create
...
public class GraphDrawer{
   ...
   * accuracy in larger
   * drawings or complicated formulas. Note that the actual number of samples drawn will depend on
   * domainBegin and
  ...
  /**
   * The alpha value to begin plotting at x. Typical interpolations begin at 0. Alpha is the term
  ...
  /**
   * The alpha value where plotting ends at x + width. Typical interpolations end at 1. Alpha is
   * the term used to
  ...
  /**
   * Alpha values less than domainBegin are not plotted. Alpha is the term used to describe the
   * linear value along the
   * x axis. To show the full graph, domainBegin must equal plotBegin and domainEnd must equal
   * plotEnd.
   */
  private float domainBegin=0;

  /**
   * Alpha values greater than domainEnd are not plotted. Alpha is the term used to describe the
   * linear value along
   * the x axis. To show the full graph, domainBegin must equal plotBegin and domainEnd must equal
   * plotEnd.
   */
  private float domainEnd=1;

  /**
   * Given any particular alpha, the resulting y value can exceed the height of the graph bounds
   * or dip below the x
   * axis. Setting rescale = true scales the graph so that y values will stay entirely inside the
   * height of the graph
   * bounds.
   */
  ...
  /**
   * <p>
   * Draws a graph with the specified Interpolation and values. GraphDrawer assumes a single,
   * continuous graph
   * formula.
   * <p>
   * Alpha is the term used to describe the linear value along the x axis. Typical y values are
   * expected to be between
   * 0 and 1 and is scaled to the height of the drawn graph. However, y values can still be
   * outside of this range. See
   * the "rescale" parameter.
   * </p>
   * <p>
   * This method overrides the class provided values
   * </p>
   *
   * @param interpolation The Interpolation that describes the graph's formula. See
   *                      {@link Interpolation} for
   ...
   * @param samples       The number of sample points to estimate the shape of the graph. Increase
   *                      this for better
   *                      accuracy in larger drawings or complicated formulas. Note that the
   *                      actual number of samples
   *                      drawn will depend on domainBegin and domainEnd. Value must be greater
   *                      than 2.
   * @param plotBegin     The alpha value to begin plotting at x. Typical interpolations begin at
   *                      0.
   * @param plotEnd       The alpha value where plotting ends at x + width. Typical interpolations
   *                      end at 1.
   ...
   * @param rescale       Given any particular alpha, the resulting y value can exceed the height
   *                      of the graph bounds
   *                      or dip below the x axis. Setting rescale = true scales the graph so that
   *                      y values will stay
   ...
   *                      {@link Interpolation} for
   *                      available defaults or create your own!
   * @param rectangle     A rectangle that defines the x, y, width, and height of the graph
   *                      drawing.
   */
   ...
   * Draws a graph with the specified Interpolation and values. GraphDrawer assumes a single,
   * continuous graph
   * formula. Alpha is the term used to describe the linear value along the x axis. Typical y
   * values are expected to
   * be between 0 and 1 and is scaled to the height of the drawn graph. However, y values can
   * still be outside of this
  ...
  /**
   * Returns the number of sample points to estimate the shape of the graph. An increase in
   * samples means better
  ...
  /**
   * Sets the number of sample points to estimate the shape of the graph. An increase in samples
  ...
  /**
   * Returns the alpha value to begin plotting at x. Alpha is the term used to describe the linear
   * value along the x
  ...
  /**
   * Sets the alpha value to begin plotting at x. Alpha is the term used to describe the linear
   * value along the x
   * axis. Typical interpolations begin at 0.
   *
  ...
  /**
   * Returns the alpha value where plotting ends at x + width. Alpha is the term used to describe
   * the linear value
  ...
  /**
   * Sets the alpha value where plotting ends at x + width. Alpha is the term used to describe the
   * linear value along
  ...
  /**
   * Returns the domainBegin value. Alpha values less than domainBegin are not plotted. Alpha is
   * the term used to
   * describe the linear value along the x axis. To show the full graph, domainBegin must equal
   * plotBegin and
  ...
  /**
   * Sets the domainBegin value. Alpha values less than domainBegin are not plotted. Alpha is the
   * term used to
   * describe the linear value along the x axis. To show the full graph, domainBegin must equal
   * plotBegin and
   * domainEnd must equal plotEnd.
  ...
  /**
   * Returns the domainEnd value. Alpha values greater than domainEnd are not plotted. Alpha is
   * the term used to
   * describe the linear value along the x axis. To show the full graph, domainBegin must equal
   * plotBegin and
   * domainEnd must equal plotEnd.
  ...
  /**
   * Sets the domainEnd value. Alpha values greater than domainEnd are not plotted. Alpha is the
   * term used to describe
   * the linear value along the x axis. To show the full graph, domainBegin must equal plotBegin
   * and domainEnd must
   * equal plotEnd.
   *
  ...
  /**
   * Returns the rescale value. Given any particular alpha, the resulting y value can exceed the
   * height of the graph
   * bounds or dip below the x axis. Setting rescale = true scales the graph so that y values will
   * stay entirely
  ...
  /**
   * Sets the rescale value. Given any particular alpha, the resulting y value can exceed the
   * height of the graph
   * bounds or dip below the x axis. Setting rescale = true scales the graph so that y values will
   * stay entirely
   * inside the height of the graph bounds.
