...
public final class PlayGameState extends GameSystemState{
  ...
  public void displayMessage(GameSystem system) {
    ...
    duel.fill(0.0f,255.0f*(1.0f-PApplet.parseFloat(properFrameCount)/messageDurationFrameCount));
    duel.text("Go",0.0f,0.0f);
  }
  @Override
  ...
  public void thrustPlayerActor(Actor referenceActor,PlayerActor targetPlayerActor) {
    ...
    final float thrustAngle=relativeAngle+duel.random(-0.5f*PConstants.HALF_PI,0.5f*PConstants.HALF_PI);
