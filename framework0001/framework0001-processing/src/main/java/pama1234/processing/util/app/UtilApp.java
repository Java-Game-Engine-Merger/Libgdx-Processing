...
public abstract class UtilApp extends PApplet{
  public void run() {
    super.runSketch();
  }
  ...
  public PointCenter<PointEntity<PathPoint>> pcenter=new PointCenter<PointEntity<PathPoint>>(this,16);
  ...
  public void windowResized() {
    // u=Math.max(1,Math.min(width,height))/scale;
    // //    strokeWeight(u/strokeScale);
    // //    textSize(32/u);
    // center.frameResized(width,height);
    frameResized(width,height);
  }
  @Override
