...
public class UkcpServerBootstrap extends AbstractBootstrap<UkcpServerBootstrap,UkcpServerChannel> implements
  ...
  /**
   * Allow to specify a {@link ChannelOption} which is used for the {@link Channel} instances once
   * they get created
   * (after the acceptor accepted the {@link Channel}). Use a value of {@code null} to remove a
   * previous set
   * {@link ChannelOption}.
   */
  ...
  /**
   * Set the specific {@link AttributeKey} with the given value on every child {@link Channel}. If
   * the value is
