...
/** 用于按照源码中的顺序打印成员变量到yaml中 */
public class OrdinalPropertyUtils extends PropertyUtils{
  ...
  public OrdinalPropertyUtils() {
    this(new PlatformFeatureDetector());
  }

  OrdinalPropertyUtils(PlatformFeatureDetector platformFeatureDetector) {
  ...
  protected Map<String,Property> getPropertiesMap(Class<?> type,BeanAccess bAccess) {
    ...
    if(debug) System.out.println(properties);
