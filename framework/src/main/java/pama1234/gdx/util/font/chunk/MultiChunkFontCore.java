...
public abstract class MultiChunkFontCore extends BetterBitmapFont{
   ...
   */
  public Vec3i posI;
  public MultiChunkFontCore(FileHandle[] fontFile,boolean flip,boolean loadOnDemand) {
    ...
    mfontData.mfont=(MultiChunkFont)this;
