...
public class TextButtonCam<T extends UtilScreen>extends TextButton<T>{
  ...
  public TextButtonCam(T p,GetBoolean active,boolean textOffset) {
    this(p);
    textOffset(textOffset)
  ...
  // @Deprecated
  public TextButtonCam(T p,boolean textOffset,GetBoolean active,
    TextButtonEvent<T> press,TextButtonEvent<T> clickStart,TextButtonEvent<T> clickEnd,
    TextButtonEvent<T> updateText,
  ...
  public TextButtonCam<T> rectHeight(float h) {
